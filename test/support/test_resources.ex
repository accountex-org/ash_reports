  ...
  defmodule AshReports.Test.Order do
    ...
    calculations do
      ...
      calculate :days_since_order,
                :integer,
                expr(date_diff(^Date.utc_today(), order_date, :day)) do
...
unless Code.ensure_loaded?(AshReports.Test.Product) do
  defmodule AshReports.Test.Product do
    ...
    calculations do
      ...
      calculate :margin_percentage, :decimal, expr((price - cost) / price * 100) do
...
unless Code.ensure_loaded?(AshReports.Test.OrderItem) do
  defmodule AshReports.Test.OrderItem do
    ...
    calculations do
      ...
      calculate :effective_unit_price,
                :decimal,
                expr((line_total - discount_amount) / quantity) do
