defmodule AshReports.LiveView.ChartLiveComponentTest do
  ...
  describe "ChartLiveComponent lifecycle" do
    test "mounts successfully with valid chart config" do
      ...
      {_view, html} = live_isolated_component(ChartLiveComponent, %{
        id: "test_chart",
    ...
    test "updates component when chart config changes" do
      ...
      {view, _html} = live_isolated_component(ChartLiveComponent, %{
        id: "updating_chart",
  ...
  describe "Interactive events" do
    ...
    test "handles chart click events", %{view: view} do
      ...
      result = render_click(view, "chart_click", %{
        "dataIndex" => "1",
        "datasetIndex" => "0"
      })
    ...
    test "handles chart hover events", %{view: view} do
      ...
      result = render_change(view, "chart_hover", %{
    ...
    test "applies filters correctly", %{view: view} do
      ...
      result = render_click(view, "apply_filter", %{
        "filter" => %{"minValue" => "110"}
      })
  ...
  describe "Real-time functionality" do
    test "enables real-time updates correctly" do
      ...
      {view, html} = live_isolated_component(ChartLiveComponent, %{
        id: "realtime_chart",
        chart_config: chart_config,
        locale: "en",
        real_time: true
  ...
  describe "Internationalization" do
    test "renders correctly in Arabic (RTL)" do
      ...
      assert html =~ "جاري تحميل"  # Arabic loading text
    end
    ...
    test "renders correctly in Spanish" do
      ...
      assert html =~ "Cargando gráfico"  # Spanish loading text
    end
  end
  ...
  describe "Accessibility" do
    test "includes proper ARIA attributes" do
      ...
      assert html =~ "tabindex=\"0\""  # Interactive chart should be focusable
    end
  ...
  describe "Performance" do
    ...
    test "memory usage remains reasonable with multiple charts" do
      ...
      charts = for i <- 1..10 do
        chart_config = %ChartConfig{
          type: Enum.random([:line, :bar, :pie]),
          data: for j <- 1..50, do: %{x: j, y: :rand.uniform(100)},
          title: "Chart #{i}"
        }
        
        {_view, _html} = live_isolated_component(ChartLiveComponent, %{
          id: "memory_chart_#{i}",
          chart_config: chart_config,
          locale: "en"
        })
