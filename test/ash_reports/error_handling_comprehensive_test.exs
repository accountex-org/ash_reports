defmodule AshReports.ErrorHandlingComprehensiveTest do
  ...
  describe "DSL path validation in error messages" do
    ...
    test "elements include correct DSL path in error messages" do
          ...
          reports do
            report :element_path_error do
              ...
              bands do
                band :error_band do
                  elements do
                    field :invalid_field  # Missing source to trigger error
                  end
                end
              end
            end
      ...
      assert error.path == [:reports, :element_path_error, :bands, :error_band, :elements, :invalid_field]
    ...
    test "deeply nested elements include correct DSL path" do
                  ...
                  bands do
                    band :level2, type: :group_header, group_level: 2 do
                      ...
                      bands do
                        band :level3 do
                          elements do
                            aggregate :invalid_agg, function: :invalid_function, source: [:amount]
                          end
                        end
                      end
                    end
      ...
      assert error.path == [:reports, :deep_nested_error, :bands, :level3, :elements, :invalid_agg, :function]
        ...
        defmodule MultipleErrorsDomain do
          ...
          reports do
            ...
            report :multiple_errors do
              ...
              bands do
                band :duplicate_name do  # Duplicate names (ValidateBands error)
                  elements do
                    field :name, source: [:name]
                  end
                end
                ...
                band :duplicate_name do  # Duplicate names (ValidateBands error)
                  elements do
                    field :invalid_field  # Missing source (ValidateElements error)
                  end
                end
              end
            end
        ...
        defmodule BandValidationOrderDomain do
          ...
          reports do
            report :band_validation_order do
              ...
              driving_resource AshReports.Test.Customer  # Valid

              bands do
                band :invalid_band, type: :invalid_type do  # Invalid band type
                  elements do
                    field :name, source: [:name]
                  end
                end
        ...
        defmodule ElementValidationOrderDomain do
          ...
          reports do
            report :element_validation_order do
              ...
              bands do
                band :valid_band do  # Valid band
                  elements do
                    field :invalid_field  # Missing source (element error)
                  end
                end
              end
            end
  ...
  describe "error message quality and context" do
        ...
        defmodule ClearErrorMessageDomain do
          ...
          reports do
            report :clear_error_message do
              ...
              driving_resource "invalid_resource"  # Should be atom
    ...
    test "error messages for duplicate names show which names are duplicated" do
              ...
              bands do
                band :duplicate_band do
                  elements do
                    ...
                    field :duplicate_element, source: [:email]  # Duplicate
                    field :another_duplicate, source: [:phone]
                    field :another_duplicate, source: [:address]  # Another duplicate
                  end
                end
              end
            end
      ...
      assert String.contains?(error.message, "duplicate_element") or String.contains?(error.message, "another_duplicate")
    end
  end
  ...
  describe "error recovery and graceful degradation" do
    ...
    test "error messages remain consistent across different error scenarios" do
      ...
      error1 = assert_raise Spark.Error.DslError, fn ->
      ...
      error2 = assert_raise Spark.Error.DslError, fn ->
