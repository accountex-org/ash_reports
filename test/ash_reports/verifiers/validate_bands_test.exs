          ...
          reports do
            report :non_sequential_detail do
              ...
              bands do
                ...
                band :detail, detail_number: 3 do  # Missing 2
                  elements do
                    field :email, source: [:email]
                  end
                end
            ...
            report :duplicate_nested do
              ...
              bands do
                ...
                band :group_header, group_level: 1 do
                  ...
                  bands do
                    band :duplicate_name do  # Duplicate name
                      elements do
                        field :name, source: [:name]
                      end
                    end
                ...
                band :group_header, group_level: 1 do
                  ...
                  bands do
                    band :invalid_nested_band do
                      type :invalid_nested_type  # Invalid type in nested structure
                      elements do
                        field :name, source: [:name]
                      end
                    end
            ...
            report :inconsistent_group_levels do
              ...
              bands do
                band :group1, type: :group_header, group_level: 1 do
                  ...
                  bands do
                    band :group2, type: :group_header, group_level: -1 do  # Invalid negative level
                      elements do
              ...
              bands do
                band :group1, type: :group_header, group_level: 1 do
                  ...
                  bands do
                    ...
                    band :detail3, type: :detail, detail_number: 3 do  # Missing detail_number 2
                      elements do
                        field :email, source: [:email]
                      end
                    end
            ...
            report :complex_hierarchy do
              ...
              bands do
                band :group_header, group_level: 1 do
                  ...
                  bands do
                    band :title do  # Title should not be nested
                      elements do
          ...
          reports do
            report :deep_nesting_duplicates do
              ...
              bands do
                ...
                band :level1 do  # Duplicate name at different nesting level
                  elements do
