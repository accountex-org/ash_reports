defmodule AshReports.Verifiers.ValidateElementsTest do
  ...
  describe "ValidateElements verifier" do
              ...
              bands do
                band :detail do
                  elements do
                    ...
                    field :duplicate_name, source: [:email]  # Duplicate name
                  end
                end
              end
            end
          ...
          reports do
            report :missing_field_source do
              ...
              bands do
                band :detail do
                  elements do
                    field :no_source_field  # Missing source
                  end
                end
              end
            end
          ...
          reports do
            report :missing_expression do
              ...
              bands do
                band :detail do
                  elements do
                    expression :no_expression  # Missing expression
                  end
                end
              end
            end
          ...
          reports do
            report :missing_image_source do
              ...
              bands do
                band :detail do
                  elements do
                    image :no_source_image  # Missing source
                  end
                end
              end
            end
            ...
            report :duplicate_nested_elements do
              ...
              bands do
                band :detail do
                  elements do
                    field :duplicate_name, source: [:name]
                    field :duplicate_name, source: [:email]  # Duplicate in same band
                  end
                end
              end
            end
        ...
        reports do
          report :same_name_different_bands do
            ...
            bands do
              ...
              band :detail do
                elements do
                  label "header", text: "Detail Header"  # Same name, different band - OK
                  field :name, source: [:name]
                end
              end
              ...
              band :summary do
                elements do
                  label "header", text: "Summary Header"  # Same name, different band - OK
                end
              end
            end
          end
    ...
    test "error messages include proper DSL path context" do
      ...
      assert error.path == [:reports, :element_error_path, :bands, :detail, :elements, :invalid_field]
  ...
  describe "comprehensive element validation" do
              ...
              bands do
                band :group_header, group_level: 1 do
                  elements do
                    ...
                    field :duplicate_name, source: [:name]  # Duplicate in same band
                  end
            ...
            bands do
              band :summary do
                elements do
                  ...
                  aggregate :avg_complex, function: :average, source: [:profile, :metrics, :score]
                end
              end
            end
          end
    ...
    test "element validation performance with large numbers of elements" do
      ...
      elements = for i <- 1..200 do
        type = case rem(i, 7) do
          0 -> :field
          1 -> :label
          2 -> :expression
          3 -> :aggregate
            ...
            bands do
              band :detail do
                elements do
                  ...
                  expression :complex_logic, expression: expr(
                    if(amount > 1000, 
    ...
    test "validates element error messages include full DSL path" do
      ...
      assert error.path == [:reports, :element_path_error, :bands, :nested_band, :elements, :invalid_field]
          ...
          reports do
            report :empty_field_source do
              ...
              bands do
                band :detail do
                  elements do
                    field :empty_source, source: []  # Empty source array
                  end
                end
              end
            end
          ...
          reports do
            report :empty_label_text do
              ...
              bands do
                band :detail do
                  elements do
                    label "empty_text", text: ""  # Empty string
                  end
                end
              end
            end
